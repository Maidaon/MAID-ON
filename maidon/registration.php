...
if(isset($_POST["submit"])){
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM tbl_users WHERE user_name = '$EnterYourUsername' OR email = '$EnterYourEmail'");
    ...
    if(mysqli_num_rows($duplicate) > 0){
        ...
        if($CreateaPassword == $Confirmpassword){
            $query = "INSERT INTO tbl_users (user_name, fullname, email, user_password) VALUES ('$EnterYourUsername','$EnterYourName','$EnterYourEmail','$CreateaPassword')";
